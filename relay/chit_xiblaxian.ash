...
buffer materials() {
	buffer mats;
	mats.append('<table style=""><tr><th colspan=2>You have:</th></tr><tr><td><img src=/images/itemimages/xicurcuit.gif width=30 height=30 onClick=\'javascript:descitem(753030502)\' alt="Xiblaxian circuitry" title="Xiblaxian circuitry"></td><td>');
