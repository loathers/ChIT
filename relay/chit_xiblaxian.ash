...
string amountify(item it) {
	...
	if(x == 0)
		return "no "+ to_plural(it);
	if(x == 1)
		return "1 "+ to_string(it);
...
buffer materials() {
	buffer mats;
	mats.append('<table style="font-family:sans-serif;"><tr><th colspan=2>You have:</th></tr><tr><td><img src=/images/itemimages/xicurcuit.gif width=30 height=30 onClick=\'javascript:descitem(753030502)\' alt="Xiblaxian circuitry" title="Xiblaxian circuitry"></td><td>');
